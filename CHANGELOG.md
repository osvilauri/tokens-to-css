...
- e0c98b7: A merge now says which tokens one source took over from another (FR-27).
...
- 3f8bfc6: A Token Source can now be a list, and the documents are merged in order (FR-27).
...
- 68a4bb1: Lee `$root`, el token propio de un grupo, en lugar de descartarlo en silencio
